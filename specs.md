...
> **Note — Cursor Behavior**
>
> The `behavior` property of the cursor controls user interaction:
>
> - `"none"` — default; cursor only shows tooltips and crosshairs.
> - `"zoomX"` — allows horizontal drag-to-zoom (X-axis range).
> - `"zoomY"` — allows vertical drag-to-zoom (Y-axis range).
> - `"zoomXY"` — enables diagonal zooming across both axes.
>
> In amCharts 5, the cursor acts as both a hover tracker **and** an interaction controller.
